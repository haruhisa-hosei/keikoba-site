// =======================================
// Unified index controller (5 seasons)
// - month -> body class
// - spring petals / summer fireworks / autumn maple
// - click: phoenix fly + fade then navigate
// =======================================
...
(() => {
  ...
  // season detect
  // ---------------------------
  function detectSeason(month){ // 1-12
    if (month === 12 || month === 1 || month === 2) return "winter";
    if (month === 3 || month === 4) return "spring";
    if (month === 7 || month === 8) return "summer";
    if (month >= 9 && month <= 11) return "autumn";
    return "plain"; // 5-6 + fallback
  }
  ...
  if (link){
    link.addEventListener("click", (e) => {
      ...
      const linkUrl = link.getAttribute("href") || "keikoba.html";
  ...
  function startFirework(){
    ...
    playFirework();
    setInterval(playFirework, LOOP_MS);
  }
